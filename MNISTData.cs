...
namespace NetworkWithMNISTData
{
    public class MNISTData
    {
        ...
        public static List<DigitImage> LoadData(string pixelFile, string labelFile, ref ProgressBar progressBar, byte numberRecognizableNumbers)
        {
            ...
            progressBar.Maximum = numTrainImages;
            progressBar.Value = 0;

            for (int di = 0; di < numTrainImages; ++di)
            {
